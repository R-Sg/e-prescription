...
class Doctor(models.Model):
    ...
    registration_number = models.IntegerField(
        unique=True, verbose_name="registration number"
    )

    # Date updated
    date_updated = models.DateTimeField(
        auto_now=True, auto_now_add=False, verbose_name="last modification date"
    )
...
class Patient(models.Model):
    ...
    date_of_consultant = models.DateField(
        null=True, blank=True, verbose_name="date when consult with doctor"
    )
