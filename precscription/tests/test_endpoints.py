...
from precscription.factories.factories import (
    DoctorFactory,
    PatientFactory,
    UserFactory,
    DrugFactory,
...
class TestPrecscription(APITestCase):
    ...
    def setUp(self):
        ...
        self.user = UserFactory(
            email="admin@admin.com", username="admin", password="pass@123"
        )
        ...
        for _ in range(3):
            precscription = Precscription.objects.create(
        ...
        self.precscription_detail_url = reverse(
            "api:precscription-detail", args=[self.precscription_list[0].id]
        )
    ...
    def test_precscription_create(self):
        ...
        response = self.client.post(
            self.precscription_list_url, self.data, format="json"
        )
