...
class Drug(models.Model):
    ...
    STRENGTH_UNIT_CHOICES = (("M", "mg"), ("G", "gm"), ("N", "ng"), ("MC", "mcg"))
    PREPARATION_CHOICES = (("T", "Tab."), ("C", "Cap."), ("I", "Inj."), ("D", "Drops"))
    ROUTE_CHOICES = (
        ("T", "Topical"),
        ("O", "Oral"),
        ("R", "Rectal"),
    ...
    DIRECTION_CHOICES = (("B", "Before meals"), ("A", "After meals"))
    FREQUENCY_CHOICES = (
        ("IR", "If required"),
        ("I", "Immediately"),
        ("OD", "Once a day"),
    ...
    DURATION_UNIT_CHOICES = (("D", "Days"), ("W", "Weeks"), ("Y", "Years"))
...
class Order(models.Model):
    ...
    precscriptions = models.ForeignKey(
        Precscription, on_delete=models.CASCADE, related_name="order_precscriptions"
    )
